...
class GenerationMixin:
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
            self, input_ids: torch.LongTensor, model_kwargs, ext_labels=None, bos_ids=None
    ) -> Dict[str, Any]:
    ...
    def _expand_inputs_for_generation(
        ...
        if 'ext_labels' in model_kwargs.keys() and 'bos_ids' in model_kwargs.keys():
            model_kwargs["ext_labels"] = model_kwargs['ext_labels'].index_select(0, expanded_return_idx)
            model_kwargs["bos_ids"] = model_kwargs['bos_ids'].index_select(0, expanded_return_idx)

        if 'input_ids_seq' in model_kwargs.keys():
            model_kwargs["input_ids_seq"] = model_kwargs['input_ids_seq'].index_select(0, expanded_return_idx)
    ...
    def generate(
            ...
            ext_labels: Optional[torch.FloatTensor] = None,
            bos_ids: Optional[torch.LongTensor] = None,
            **model_kwargs,
        ...
        if self.config.is_encoder_decoder:
            ...
            model_kwargs = self._prepare_encoder_decoder_kwargs_for_generation(input_ids, model_kwargs, ext_labels=ext_labels, bos_ids=bos_ids)
        ...
        if is_greedy_gen_mode:
            ...
            model_kwargs['bos_ids'] = bos_ids
            model_kwargs['input_ids_seq'] = self.raw_input_ids
        ...
        while True:
            ...
            outputs = self(
                **model_inputs,
                ...
                output_attentions=output_attentions,
                output_hidden_states=output_hidden_states,
                ext_labels=model_kwargs['ext_labels'],
                bos_ids=model_kwargs['bos_ids'],
                is_inference=True,
            )
                # input_ids_seq=model_kwargs['input_ids_seq'],
