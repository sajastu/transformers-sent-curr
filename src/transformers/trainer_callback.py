...
class CallbackHandler(TrainerCallback):
    ...
    def __init__(self, callbacks, model, tokenizer, optimizer, lr_scheduler, optimizer_ext, lr_scheduler_ext):
        self.callbacks = []
        for cb in callbacks:
        ...
        self.optimizer_ext = optimizer_ext
        self.lr_scheduler = lr_scheduler
        self.lr_scheduler_ext = lr_scheduler_ext
